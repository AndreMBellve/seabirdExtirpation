...
630
output-file-name
./output/no_pred_recolonisation_meta.csv
1
0
String
...
@#$#@#$#@
<experiments>
  <experiment name="recolonisation_pred_analysis" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>step</go>
    ...
    <enumeratedValueSet variable="behav-output-path">
      <value value="&quot;./output/recolonisation_analysis/pred/&quot;"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="output-file-name">
      <value value="&quot;./output/no_pred_recolonisation_meta.csv&quot;"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="initialisation-data">
      <value value="&quot;./data/recolonisation_analysis/0_starting_chick_pred.csv&quot;"/>
      <value value="&quot;./data/recolonisation_analysis/100_starting_chick_pred.csv&quot;"/>
      <value value="&quot;./data/recolonisation_analysis/200_starting_chick_pred.csv&quot;"/>
      <value value="&quot;./data/recolonisation_analysis/300_starting_chick_pred.csv&quot;"/>
      <value value="&quot;./data/recolonisation_analysis/400_starting_chick_pred.csv&quot;"/>
      <value value="&quot;./data/recolonisation_analysis/500_starting_chick_pred.csv&quot;"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="enso-adult-mort">
      <value value="&quot;[0 0 0.01 0.025 0.05]&quot;"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="enso-breed-impact">
      <value value="&quot;[0 0.05 0.1 0.25 0.5]&quot;"/>
    </enumeratedValueSet>
  </experiment>
  <experiment name="recolonisation_no_pred_analysis" repetitions="100" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>step</go>
    <final>behav-csv</final>
    <timeLimit steps="400"/>
    ...
    <enumeratedValueSet variable="behav-output-path">
      <value value="&quot;./output/recolonisation_analysis/no_pred/&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="chick-mortality">
      <value value="0.4"/>
    </enumeratedValueSet>
    ...
    <enumeratedValueSet variable="initialisation-data">
      <value value="&quot;./data/recolonisation_analysis/0_starting_no_chick_pred.csv&quot;"/>
      <value value="&quot;./data/recolonisation_analysis/100_starting_no_chick_pred.csv&quot;"/>
      <value value="&quot;./data/recolonisation_analysis/200_starting_no_chick_pred.csv&quot;"/>
      <value value="&quot;./data/recolonisation_analysis/300_starting_no_chick_pred.csv&quot;"/>
      <value value="&quot;./data/recolonisation_analysis/400_starting_no_chick_pred.csv&quot;"/>
      <value value="&quot;./data/recolonisation_analysis/500_starting_no_chick_pred.csv&quot;"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="enso?">
      <value value="true"/>
    </enumeratedValueSet>
